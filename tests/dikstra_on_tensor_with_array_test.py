import unittest
import torch
from src.dijkstra import dijkstra_on_tensor_with_array

class Test_Dijkstra_Tensor_With_Array(unittest.TestCase): 
    
    def test_dijkstra_on_tensor_with_tensor_01(self): 
        potential_field_value_tensor = torch.tensor([[1,1,1], [5,4,1], [7,9,1]])
        path, _ = dijkstra_on_tensor_with_array(potential_field_value_tensor, (0,0), (2,2), 3, 3)
    ...
    def test_dijkstra_on_tensor_with_tensor_02(self): 
        ...
        path, _ = dijkstra_on_tensor_with_array(potential_field_value_tensor, (0,0), (2,2), 4, 3)
        solution = ((0,0), (1,0), (2,0), (2,1), (2,2))
